        ...
        <div class="row mt-4">
            <div class="offset-1 col-10">
                <select class="form-select border-dark" name="conv_tipoNac" id="conv_tipoNac">
                    ...
                    <option value="Practicas" {{ old('conv_tipoNac') == "Practicas" ? 'selected': '' }}>Practicas</option>
                    <option value="Interadministrativo" {{ old('conv_tipoNac') == "Interadministrativo" ? 'selected': '' }}>Interadministrativo</option>
