...
@section('title', 'Movilidades Nacionales Salientes')
...
<form action="" class="border border-2 rounded-3 shadow-lg mt-5 mb-5" style="width: 95%;">
    ...
    <div class="row mt-4 p-3 shadow-lg rounded-3 titles">
        <div class="offset-1 col-10">
            <h4 class="text-center ">Movilidades Nacionales Salientes</h4>
        </div>
    </div>
    <div class="row mt-4">
        <div class="offset-1 col-10">
                            ...
                            @foreach ($movnaent as $item)
                                <tr><td class="text-center"> {{ $item->id }} </td>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col">
                                                <a class="btn btn-primary  w-100" href="{{ route('movilidadNacSal.edit', $item->id) }}">Editar</a>
                                            </div>
                                        </div>
                                        <form action="{{route('movilidadNacSal.update', $item->id)}}" method="POST" class="form-delete">
                                            @csrf
                                            <div class="row mt-1">
                                                <div class="col">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('movNacSal.export') }}">
                            <div class="form-group mb-2">
                                <label for="desde">Desde:</label>
                                <input type="date" class="form-control" name="mns_initialDate" id="mie_initialDate">
                            </div>
                            <div class="form-group mb-2">
                                <label for="desde">Hasta:</label>
                                <input type="date" class="form-control" name="mns_finalDate" id="mie_initialDate" >
                            </div>
