...
@section('title', 'Movilidades Internacionales Salientes')
...
<form action="" class="border border-2 rounded-3 shadow-lg mt-5 mb-5" style="width: 95%;">
    ...
    <div class="row mt-4 p-3 shadow-lg rounded-3 titles">
        <div class="offset-1 col-10">
            <h4 class="text-center ">Movilidades Internacionales Salientes</h4>
        </div>
    </div>
    <div class="row mt-4">
        <div class="offset-1 col-10">
                            ...
                            @foreach ($movintsal as $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col">
                                                <a class="btn btn-primary  w-100" href="{{ route('movilidadIntSal.edit', $item->id) }}">Editar</a>
                                            </div>
                                        </div>
                                        <form action="{{route('movilidadIntSal.destroy', $item->id)}}" method="POST" class="form-delete">
                                            @csrf
                                            <div class="row mt-1">
                                                <div class="col">
                                                    @csrf
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('movIntSal.export') }}">
                            <div class="form-group mb-2">
                                <label for="desde">Desde:</label>
                                <input type="date" class="form-control" name="mis_initialDate" id="mie_initialDate">
                            </div>
                            <div class="form-group mb-2">
                                <label for="desde">Hasta:</label>
                                <input type="date" class="form-control" name="mis_finalDate" id="mie_initialDate" >
                            </div>
