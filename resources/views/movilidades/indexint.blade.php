...
@section('title', 'Movilidades Internacionales')
                                    ...
                                    <td>
                                        <div class="row mt-2">
                                            <div class="col d-flex flex-row p-0">
                                                <a style="margin: 0 0.8rem" class="w-auto btn btn-primary w-100" href="{{ route('movilidades_int.edit', $movilidadConActividades['movilidad']->id) }}">Editar</a>
                                                <form action="{{ route('movilidades_int.destroy', $movilidadConActividades['movilidad']->id) }}" method="POST" class="form-delete">
                                                    @csrf
